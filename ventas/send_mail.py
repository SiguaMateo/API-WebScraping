try:
    ...
    print(f"Ocurrio un error al importar las librerias en ventas, {e}")
...
def send_error_email(error_message):
    try:
        ...
        data_base.log_to_db(1, "ERROR", f"Ocurrio un error al enviar el correo, {e}", endpoint='fallido', status_code=500)